...
const AssignPembimbingModal = ({
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      await api(`/penugasan/${tugasAkhir.id}/assign`, {
        method: 'POST',
        body: assignmentData,
      });
      onSave();
      ...
      <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-lg">
        ...
        <p className="mb-6">
          ...
          <span className="font-semibold">
            {tugasAkhir.mahasiswa.user.name} - {tugasAkhir.judul}
          </span>
        </p>
        {error && (
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <select
              value={pembimbing1Id}
              onChange={(e) => setPembimbing1Id(Number(e.target.value))}
              required
          ...
          <div className="mb-6">
            ...
            <select
              value={pembimbing2Id}
              onChange={(e) => setPembimbing2Id(Number(e.target.value))}
              className="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
            >
            ...
            {unassignedTAs.length > 0 ? (
              ...
              <tr>
                <td colSpan={3} className="py-4 px-6 text-center text-gray-500">
                  Tidak ada tugas akhir yang perlu ditugaskan.
                </td>
              </tr>
            )}
          </tbody>
